...
namespace QiQiuYun\SDK\Request;

use QiQiuYun\SDK\Exceptions\ServerException;
use QiQiuYun\SDK\Exceptions\ResponseException;
...
class Request
{
    ...
    protected function _makeAuthToken($url, $params)
    {
        ...
        return "{$this->config['accessKey']}:{$hash}";
    }
